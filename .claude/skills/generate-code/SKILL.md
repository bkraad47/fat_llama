...
3. The subagent's final message is JSON per the contract in `.claude/agents/rules/scientific-coding.md`. Relay it:
   - Interactively: a short human summary first (the hypothesis tested, what changed, verification result), then the JSON.
