...
| Metric | Score | Notes |
|---|---|---|
| Coherence (upscale quality, 0-10) | 9 | Clean on every check - 0 NaN/Inf, clipping fraction 5.14e-5 (below the reference's own 1.69e-4), 0 unmatched dropouts, discontinuity p99.9 0.0165 vs reference 0.0582 (ratio 0.28, smoother not clickier), and above-Nyquist content at -147.5 dB rel in-band peak - with genuinely measurable, HF-selective added detail below 22050 Hz (+3.08 dB in the reference's quiet 13.3-22.0 kHz bins vs +0.60 dB in loud bins; 100-6000 Hz unchanged within 0.25 dB), held just below 10 by a small overall in-band lift (+1.57 dB median, +0.71 dB noise floor). |
| Spectral deviation vs. reference FLAC (0-10) | 9.0 | convergence=0.8166, correlation=0.9830 against input_test.flac (both mono-downmixed at a common 308700 Hz, trimmed to 4672878 samples, STFT nperseg=2048/noverlap=1024, each spectrogram max-normalized); the high correlation with a lower convergence reflects a small uniform in-band magnitude offset rather than a shape mismatch. |
